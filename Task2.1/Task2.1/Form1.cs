...
namespace Task2._1
{
    public partial class Form1 : Form
    {
        ...
        // автоподстановка символов формата номера телефона
        //private void PhoneNumberBox_TextChanged(object sender, EventArgs e)
        //{

        //    if (PhoneNumberBox.TextLength == 1)
        //    {
        //        PhoneNumberBox.Text += "(";

        //        PhoneNumberBox.SelectionStart = PhoneNumberBox.TextLength;
        //        PhoneNumberBox.Focus();
        //    }
        //    else if (PhoneNumberBox.TextLength == 5)
        //    {
        //        PhoneNumberBox.Text += ")";
        ...
        //        PhoneNumberBox.Focus();
        //    }
        //    else if (PhoneNumberBox.TextLength == 9 || PhoneNumberBox.TextLength == 12)
        //    {
        //        PhoneNumberBox.Text += "-";
